...
open class BugImageCreator {
  open class func drawToCurrentContext(size: CGFloat, center: CGPoint, lineWidth: CGFloat, color: UIColor) {
    ...
    context.addArc(center: bodyCenter, radius: r, startAngle: -CGFloat.pi / 3, endAngle: -CGFloat.pi / 3 * 2, clockwise: false)
    context.closePath()

    // head
    let headCenter = CGPoint(x: cx, y: cy - sin(CGFloat.pi / 3) * r)
    context.addArc(center: headCenter, radius: hr, startAngle: 0, endAngle: CGFloat.pi, clockwise: true)

    context.addLines(between: [
      CGPoint(x: cx, y: cy - sin(CGFloat.pi / 3) * r),
      CGPoint(x: cx, y: cy + r),
    ])

    // antennae
    context.addLines(between: [
      CGPoint(x: headCenter.x + cos(CGFloat.pi / 5 * 2) * hr, y: headCenter.y + sin(-CGFloat.pi / 5 * 2) * hr),
      CGPoint(x: headCenter.x + cos(CGFloat.pi / 5 * 2) * hr + a, y: headCenter.y - sin(CGFloat.pi / 5 * 2) * hr - a),
    ])
    context.addLines(between: [
      CGPoint(x: headCenter.x - cos(CGFloat.pi / 5 * 2) * hr, y: headCenter.y + sin(-CGFloat.pi / 5 * 2) * hr),
      CGPoint(x: headCenter.x - cos(CGFloat.pi / 5 * 2) * hr - a, y: headCenter.y - sin(CGFloat.pi / 5 * 2) * hr - a),
    ...
    context.addLines(between: [
      CGPoint(x: cx + cos(CGFloat.pi / 6) * r, y: cy - sin(CGFloat.pi / 6) * r),
      CGPoint(x: cx + cos(CGFloat.pi / 6) * (r + f), y: cy - sin(CGFloat.pi / 6) * (r + f)),
    ])
    context.addLines(between: [
      CGPoint(x: cx + cos(CGFloat.pi / 6) * r, y: cy + sin(CGFloat.pi / 6) * r),
      CGPoint(x: cx + cos(CGFloat.pi / 6) * (r + f), y: cy + sin(CGFloat.pi / 6) * (r + f)),
